Shader "Warren's Fast Fur/Special Variants/Fast Fur - Skin-Only Lite"
{
	Properties
	{
...
// REMOVED in RC.1 //		[NOSCALEOFFSET]_TestMap ("Test Map", 2D) = "white" {}
	...
	SubShader
	{
		...
		// scale is different, so we need to disable it.
		...
		Pass
		{
			...
			#define FUR_USE_SHADOWS

			#define FUR_SKIN_LAYER
			#define FUR_SKIN_ONLY
